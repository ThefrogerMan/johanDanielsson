    ...
    <div className="">
      ...
      <Section title="Make it work">
          ...
          <p className="min-w-1/4">
            ...
            input, ease of building the tree and look of the dialog speed. 
      ...
      <Section title="Make it Right" image={screenIteration}>
        <p className="min-w-1/2">
          ...
          a repetable sound woth differnent pitch, similar to banjo kazooie voice linces.
      ...
      <Section title="Make it Pretty" image={walkingGIF}>
